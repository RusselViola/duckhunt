...
RSpec.describe ListingsController, type: :controller do
  ...
  describe "GET #index" do
    xit "assigns all listings as @listings" do
  ...
  describe "GET #show" do
    xit "assigns the requested listing as @listing" do
      listing = Listing.create! valid_attributes
  ...
  describe "GET #new" do
    xit "assigns a new listing as @listing" do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      xit "assigns a newly created listing as @listing" do
        post :create, params: {listing: valid_attributes}, session: valid_session
        expect(assigns(:listing)).to be_a(Listing)
        expect(assigns(:listing)).to be_persisted
      end

      xit "redirects to the created listing" do
        post :create, params: {listing: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      xit "assigns a newly created but unsaved listing as @listing" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      xit "updates the requested listing" do
        listing = Listing.create! valid_attributes
      ...
      xit "redirects to the listing" do
        listing = Listing.create! valid_attributes
        put :update, params: {id: listing.to_param, listing: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      xit "assigns the listing as @listing" do
        listing = Listing.create! valid_attributes
  ...
  describe "DELETE #destroy" do
    xit "destroys the requested listing" do
      listing = Listing.create! valid_attributes
      expect {
    ...
    xit "redirects to the listings list" do
      listing = Listing.create! valid_attributes
      delete :destroy, params: {id: listing.to_param}, session: valid_session
